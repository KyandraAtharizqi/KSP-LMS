        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <dl class="row mb-4">
                    ...
                    <dd class="col-sm-9">
                        <textarea name="materi" id="materi" rows="3" class="form-control" required></textarea>
                    </dd>

                    <dt class="col-sm-3">Ide/Saran untuk Dikembangkan di PT KSP</dt>
                    <dd class="col-sm-9">
                        <textarea name="narasumber" id="narasumber" rows="3" class="form-control" required></textarea>
                    </dd>
